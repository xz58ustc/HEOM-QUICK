...
!
linewidth(1:nalf,1:norbs) = 0.02d0
linewidth(3,1:norbs) = 0.001d0
!
...
452 format(' $para1  eup=', f12.6, 2x, 'edown=', f12.6, 2x, 'uu=', f12.6, 2x, 'fixdot=', L7, ' $end')
...
461 format(' $bfield  lbfield=', L7, 2x, 'dbfield=', f12.6, 2x, '$end')
!
