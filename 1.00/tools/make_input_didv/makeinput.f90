...
real*8  :: aoffL, aoffR, phioffL, phioffR, deltav
integer :: nalf
real*8  :: crit
...
!
engyshift(1,1:nspin) =  0 
engyshift(2,1:nspin) = vv + deltav
!
! write to file
!
...
!
write(7,*)
write(7,*)'$jobinfo lsparse=T  psdfff=T  itype_fff=1  $end'
write(7,*)
write(7,*)'$bathcorr lspcor=T  $end '
write(7,*)' 0.128  0.192  ' 
write(7,*)' 0.431  0.431  ' 
write(7,*)
!
