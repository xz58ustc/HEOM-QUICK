...
dinvbeta(1:nalf) = 0.015d0

!
! WBL : bandwidth >> linewidth
!
linewidth(1:nalf,1:norbs) = 0.2d0
!
...
!engyshift(1,1:nspin) = -0.5d0
!engyshift(2,1:nspin) =  0.5d0
!
! write to file
!
...
!
write(7,*)
write(7,*)'$converge  crit=', 1.d-8, ' $end'
call flush(7)
!
iorbs_dos = 1
ispin_dos = 1
...
!
write(7,*)
write(7,*)'$jobinfo  lsparse=T   lsimple=F  $end '
call flush(7)
!
close(7)
!
